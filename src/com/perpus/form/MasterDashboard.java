...
public class MasterDashboard extends javax.swing.JPanel {
 ...
 private int jumlahAnggota(){
    ...
    private void setTableModelPeminjaman(){
        ...
        model.addColumn("Status Peminjaman"); // Menghapus Jumlah Pinjam karena tidak ada di skema
    }
    ...
    private void getDataPeminjaman(DefaultTableModel model){
        ...
        try {
            String sql = "SELECT pmd.ID_Peminjaman, pmj.Tanggal_Peminjaman, " +
                        ...
                        "bk.Judul_Buku, pmd.Status_Peminjaman " +
            ...
            while(rs.next()){
                ...
                Object[] rowData = {"   " + no++, idPeminjaman, tanggalPeminjaman, tanggalPengembalian, namaAnggota, idBuku, judulBuku, statusPeminjaman};
