...
public class LaporanPengguna extends javax.swing.JPanel {
    ...
    private void setLayoutForm() {
        // Ganti icon sesuai tema user/pengguna
        ...
        txtSearch.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Cari Nama / Username / Email");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Laporan > Pengguna");
    ...
    // Button Halaman
  private void paginationPengguna() {
    ...
    private int getTotalData() {
        ...
        try {
            ...
            Logger.getLogger(LaporanPengguna.class.getName()).log(Level.SEVERE, null, e);
        }
        return totalData;
    }
    ...
    public void getData(int startIndex, int entriesPage, DefaultTableModel model) {
        model.setRowCount(0);
        try {
            String sql = "SELECT u.ID_User, u.Nama_Full, u.Nama_User, u.Email, u.Role, "
                       + "COALESCE(p.Nama_Pegawai, '-') AS Nama_Pegawai "
                       + "FROM user u "
                       + "LEFT JOIN pegawai p ON u.Pegawai_ID_Pegawai = p.ID_Pegawai "
                       + "ORDER BY u.ID_User LIMIT ?, ?";
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    Object[] rowData = { " " + no++, idUser, namaFull, username, email, role, pegawai };
    ...
    private void searchData() {
        ...
        try {
            String sql = "SELECT u.ID_User, u.Nama_Full, u.Nama_User, u.Email, u.Role, "
                       ...
                       + "FROM user u "
                       + "LEFT JOIN pegawai p ON u.Pegawai_ID_Pegawai = p.ID_Pegawai "
                       + "WHERE u.Nama_Full LIKE ? OR u.Nama_User LIKE ? OR u.Email LIKE ? "
                       + "ORDER BY u.ID_User";
            try (PreparedStatement st = conn.prepareStatement(sql)) {
    ...
    private void cetakLaporan() {
        try {
            // Ganti path sesuai lokasi file Jasper Anda
            String reportPath = "src/com/perpus/reports/LaporanPengguna.jasper";
