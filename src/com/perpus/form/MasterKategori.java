...
public class MasterKategori extends javax.swing.JPanel {
    ...
    private void setLayoutForm(){
        iconJudul.setIcon(new FlatSVGIcon("com/perpus/icon/kategori.svg", 1f));
        iconJudul2.setIcon(new FlatSVGIcon("com/perpus/icon/kategori.svg", 1f));
        ...
        txtID.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "ID Kategori");
        txtDeskripsi.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Masukkan Deskripsi Kategori");
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Tambah Data Kategori Helpdesk");
        ...
        cboPrioritas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tinggi", "Sedang", "Rendah" }));
                ...
                .addGroup(panelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelAddLayout.createSequentialGroup()
                        .addGroup(panelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cboPrioritas, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        panelAddLayout.setVerticalGroup(
            ...
            .addGroup(panelAddLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cboKategori, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cboPrioritas, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private int getTotalData(){
        ...
        try {
            ...
            Logger.getLogger(MasterKategori.class.getName()).log(Level.SEVERE,null,e);
        }
    ...
    private void showPanel(){
        panelMain.removeAll();
        panelMain.add(new MasterKategori());
        panelMain.repaint();
        panelMain.revalidate();
    }
        ...
        try {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    Object[] rowData = {"   " + no++, idKategori, namaKategori, deskripsi, prioritas, createdAt};
    ...
    private String setIDKategori(){
        ...
        try (PreparedStatement st = conn.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                urutan = "KTM" + no + String.format("%03d", nomor);
            ...
            JOptionPane.showMessageDialog(this, "Gagal menghasilkan ID: " + e.getMessage() + ". Menggunakan default KTM" + no + "001.", "Error", JOptionPane.ERROR_MESSAGE);
            urutan = "KTM" + no + "001"; // Fallback
        }
    ...
    private void insertData() {
        ...
        String namaKategori = cboKategori.getSelectedItem().toString();
        String deskripsi = txtDeskripsi.getText();
        String prioritas = cboPrioritas.getSelectedItem().toString();
        
        if(idKategori.isEmpty() || deskripsi.isEmpty()){
            JOptionPane.showMessageDialog(this, "Semua kolom harus diisi !", "Validasi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        try {
            String sql = "INSERT INTO kategori (id_kategori, nama_kategori, deskripsi, prioritas) VALUES (?,?,?,?)";
            try(PreparedStatement st = conn.prepareStatement(sql)){
    ...
    private void dataTabel() {
        ...
        jLabel5.setText("Perbarui Data Kategori Perpustakaan");
        
        txtID.setEnabled(false);
        
        txtID.setText(tblData.getValueAt(row, 1).toString());
        cboKategori.setSelectedItem(tblData.getValueAt(row, 2).toString());
        txtDeskripsi.setText(tblData.getValueAt(row, 3).toString());
        cboPrioritas.setSelectedItem(tblData.getValueAt(row, 4).toString());
    }
    ...
    private void updateData() {
        ...
        try {
            String sql = "UPDATE kategori SET nama_kategori=?, deskripsi=?, prioritas=? WHERE id_kategori=?";
            try(PreparedStatement st = conn.prepareStatement(sql)){
                st.setString(1, namaKategori);
                st.setString(2, deskripsi);
                st.setString(3, prioritas);
