...
public class DataKategori extends javax.swing.JDialog {
    ...
    private int getTotalData(){
        ...
        try {
            ...
            Logger.getLogger(DataKategori.class.getName()).log(Level.SEVERE,null,e);
        }
    ...
    public void getData(int startIndex, int entriesPage, DefaultTableModel model) {
        ...
        try {
            String sql = "SELECT id_kategori, nama_kategori, deskripsi, prioritas FROM kategori LIMIT ?,?";
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    String deskripsi = rs.getString("deskripsi") != null ? rs.getString("deskripsi") : "";
                    String prioritas = rs.getString("prioritas");

                    Object[] rowData = {"   " + no++, idKategori, namaKategori, deskripsi, prioritas};
    ...
    private void searchData() {
        ...
        try {
            String sql = "SELECT id_kategori, nama_kategori, deskripsi, prioritas FROM kategori WHERE id_kategori LIKE ? OR nama_kategori LIKE ? OR prioritas LIKE ?";
            try (PreparedStatement st = conn.prepareStatement(sql)){
    ...
    private void pilihData(){
        ...
        idKategori = tblData.getValueAt(row, 1).toString();
        namaKategori = tblData.getValueAt(row, 2).toString();
        deskripsi = tblData.getValueAt(row, 3).toString();
        prioritas = tblData.getValueAt(row, 4).toString();
